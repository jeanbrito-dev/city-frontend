...
export default function AdminSidebar() {
  ...
  return (
    <div className="w-full min-h-full bg-slate-900 text-slate-100 flex flex-col border-r border-slate-800 shadow-xl">
      {/* Header / Logo */}
      ...
      {/* Footer Section */}
      <div className="p-3 border-t border-slate-800/60 bg-slate-950/40 flex flex-col gap-2">
        {/* Profile Card */}
