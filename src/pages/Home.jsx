...
const mobileCards = [
  {
    ...
    description: "Visualize todas as ocorrências reportadas em Caraguatatuba em tempo real",
  },
  {
    title: "Reporte Ocorrências",
    description: "Ajude a melhorar a cidade reportando problemas de infraestrutura, segurança e mais",
  },
  {
    title: "Transparência",
    description: "Acompanhe o status das ocorrências e veja as ações tomadas pela administração",
  },
];
  ...
  return (
    <div className="hidden lg:block">
      <div className="relative min-h-190 w-full overflow-hidden">
        ...
        <div className="relative flex min-h-190 flex-col items-start px-12 py-23">
    ...
    <section className="w-full bg-white text-black">
      ...
      <section className="px-8 py-16 sm:px-10 lg:px-14.5 lg:pt-20 lg:pb-30">
        ...
        <div className="hidden lg:block">
          ...
          <div className="mx-auto max-w-275 grid grid-cols-[360px_1fr] gap-10 items-start">
            <div>
            ...
            <div>
              <div className="relative h-72.5">
                <img
                  src={sectionImageOne}
                  alt="Praia de Caraguatatuba"
                  className="absolute left-2.5 top-0 h-49.5 w-60 rounded-xl object-cover shadow-[0_6px_20px_rgba(0,0,0,0.10)]"
                />
                <img
                  src={sectionImageTwo}
                  alt="Cidade"
                  className="absolute left-32.5 top-15.5 h-56 w-62 rounded-xl object-cover shadow-[0_8px_24px_rgba(0,0,0,0.14)]"
                />
              </div>

              <div className="mt-8.5 grid grid-cols-2 gap-x-8 gap-y-9.5">
